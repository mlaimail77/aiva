...
class ASRServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TranscribeStream = channel.stream_stream(
                '/cyberverse.ASRService/TranscribeStream',
                request_serializer=common__pb2.AudioChunk.SerializeToString,
                response_deserializer=asr__pb2.TranscriptEvent.FromString,
...
def add_ASRServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TranscribeStream': grpc.stream_stream_rpc_method_handler(
                    ...
                    response_serializer=asr__pb2.TranscriptEvent.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'cyberverse.ASRService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cyberverse.ASRService', rpc_method_handlers)
...
class ASRService(object):
    ...
    def TranscribeStream(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            asr__pb2.TranscriptEvent.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
